"""Typed provenance edges connecting claimkit's nodes into a graph.
...
class NodeType(enum.StrEnum):
    ...
    Attributes:
        CLAIM: A :class:`~claimkit.core.claim.Claim`.
        EVIDENCE: A piece of :class:`~claimkit.core.evidence.Evidence`.
        ACTIVITY: An :class:`~claimkit.core.activity.Activity`.
