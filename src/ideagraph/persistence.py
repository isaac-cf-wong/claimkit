"""Saving and loading a :class:`~ideagraph.core.graph.ProvenanceGraph` as JSON.
...
SCHEMA_VERSION = 3  # v3: + article_id, graph metadata, cross_references. v2: claims -> statements.
