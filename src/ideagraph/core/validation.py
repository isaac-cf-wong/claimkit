"""Resolving a claim's :class:`~ideagraph.core.claim.ClaimStatus` from evidence.
...
bears on a claim. The :attr:`~ideagraph.core.evidence.Evidence.relation` field is
...
:mod:`ideagraph.core.staleness`; callers that want both decide the precedence.
